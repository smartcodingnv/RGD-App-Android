...
import kotlinx.android.synthetic.main.activity_notification_list.toolbar
...
class NotificationListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gson = Gson()
        val notification =
            gson.fromJson(helper!!.LoadStringPref(AppConfig.PREFERENCE.NOTIFICATIONRESPONCE, ""), ResponceNotification::class.java)
